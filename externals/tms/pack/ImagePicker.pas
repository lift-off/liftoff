...
type
  ...
  public
    ...
    property Items[Index: Integer]: TImagePickerItem read GetItem write SetItem;
...
{$IFNDEF DELPHI5_LVL}
procedure TImagePicker.CNDrawItem(var Message: TWMDrawItem);
begin
