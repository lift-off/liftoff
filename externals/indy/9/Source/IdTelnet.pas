...
{
{   Rev 1.2    3/29/04 11:36:58 AM  RLebeau
{ Updated TIdTelnetReadThread so that TIdTelnet.Negotiate() is called from
{ Synchronize() when ThreadedEvent is false.  This is to ensure that the
{ OnTelnetCommand event handler is synchronized when needed.
}
{
{   Rev 1.1    2/11/04 1:59:30 AM  RLebeau
{ Added ThreadedEvent property
}
{
