...
uses
  InspectorBar, Classes, Messages, Windows, Controls, SysUtils, Graphics, INIFiles;
...
var
  IniFile: TIniFile;
begin
  if PropertyType = ptText then
  begin
    IniFile := TIniFile.Create(TINIInspectorBar(InspectorBar).IniFile);
