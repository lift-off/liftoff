...
var
  ...
  GetThemePartSize: function(hTheme: HTheme; ADC :HDC;
                             iPartId, iStateID: Integer;
                             r: PRect;eSize: THEMESIZE; var Size: TSize): THandle cdecl stdcall;
