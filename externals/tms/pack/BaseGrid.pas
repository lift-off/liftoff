...
type
  ...
  TColumnCalcType = (acNONE,acSUM,acAVG,acCOUNT,acMIN,acMAX,acSPREAD);
  ...
  protected
    ...
    procedure GetVisualProperties(ACol,ARow: Integer; var AState: TGridDrawState; Print, Select, Remap: Boolean;
      ABrush: TBrush; var AColorTo: TColor; AFont: TFont; var HA: TAlignment; var VA: TVAlignment; var WW: Boolean); virtual;
...
begin
  ...
  GetVisualProperties(ACol,ARow,AState,False,True,True,Canvas.Brush,AColorTo,Canvas.Font,HA,VA,WW);
  Canvas.Pen.Color := Canvas.Brush.Color;

  if AColorTo <> clNone then
    DrawGradient(Canvas,Canvas.Brush.Color,AColorTo,64,ARect,true)
  else
    Canvas.Rectangle(ARect.Left,ARect.Top, ARect.Right ,ARect.Bottom);
