...
type
  ...
  published
    ...
    property PrintPreview: Boolean read FPrintPreview write SetPrintPreview;
...
begin
  ...
  if (pos('.',fn)=0) and (OpenDialog1.FilterIndex=1) then fn := fn + '.ini';
...
begin
  ...
  if (pos('.',fn)=0) and (SaveDialog1.FilterIndex=1) then fn := fn + '.ini';
